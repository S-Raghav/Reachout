...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2015 at 05:09 AM
...
INSERT INTO `grievance` (`post_id`, `required`, `current`) VALUES
('15-02-01 18:02:37', 3, 0);
...
INSERT INTO `posts` (`type`, `poster_id`, `content`, `highest_bid`, `domain`, `post_id`, `completed`) VALUES
('Job', 'suit', 'i need plumber', 100.00, 'plumbing', '15-02-01 18:02:10', 0),
('grievance', 'suit', 'aasdfad', 0.00, 'asasa', '15-02-01 18:02:37', 0);
